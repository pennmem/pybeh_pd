function CI = LoftusMasson(dat)
% function CI = LoftusMasson(dat)
% this function produces Loftus-Masson corrected errorbars for your data.
% It assumes that your subjects are the rows of the data and the columns
% are different treatments (i.e., within-subject design).
...
CI = sqrt(estimator./Nsubj)*tinv(.975,size(dat,1)-1);
...
% CI = sqrt(MSint/numRows)*criterion*ones(1,numCols);
